...
void getCube(float*& vertices, unsigned int& VAO, unsigned int& VBO, unsigned int& EBO);
void getLight(float*& vertices, unsigned int& VAO, unsigned int& VBO, unsigned int& EBO);
...
int main()
{
    ...
    Shader ourshader("/Users/zhouxch/Playground/opengl_test/opengl_test/shader1.vs", "/Users/zhouxch/Playground/opengl_test/opengl_test/shader1.fs");
    ...
    // getSquare(vertices, indices, VAO, VBO, EBO);
    getCube(vertices, VAO, VBO, EBO);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        projection = glm::perspective((float)glm::radians(45.0f), (float)SCR_WIDTH / SCR_HEIGHT, 1.0f, 100.0f);
...
//        ourshader.setVec4f("ourColor", glm::vec4(0.0f, greenValue, 0.0f, 0.0f));
