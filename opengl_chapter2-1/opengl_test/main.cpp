...
//    cubeshader.setVec3f("lightPos", glm::vec3(2.0f, 0.0f, -2.0f));
    cubeshader.setVec3f("light.ambient", glm::vec3(0.2f, 0.2f, 0.2f));
    cubeshader.setVec3f("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f));
    cubeshader.setVec3f("light.specular", glm::vec3(1.0f, 1.0f, 1.0f));
...
void genTexture(unsigned int& texture)
{
    ...
    unsigned char *data = stbi_load("/Users/zhouxch/Playground/opengl_test/opengl_test/media/container.jpg", &width, &height, &nrChannels, 0);
    if (data) {
